/**
 * This file is a modfified version of GridView.js from Game Closure SDK.
 * Modification is done to equalze the border for the cells and
 * to set an image as background for the grid/
 *
 * @license
...
import ui.ImageScaleView as View;
