...
exports = Class(ImageView, function (supr) {
	...
	this.init = function (opts) {
		...
		opts.text && this.text.updateOpts(opts.text);
	};
	...
	this.pop = function (text, position) {
		...
		var sv = this.getSuperview(),
			...
			inAnim = {}, outAnim = {};
		inAnim['d'+prop] = pos.negFirst ? -this.style[dim] - 50 : this.style[dim] + 50;
		outAnim['d'+prop] = pos.negFirst ? this.style[dim] + 50 : -this.style[dim] - 50;
